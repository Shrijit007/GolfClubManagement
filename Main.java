...
class golfClub{
    ...
    public void display() {
        String format = "| %-9s | %-10s | %-10s | %-8d | %-6s | %-10s | %-12s | %-6s | %-10s | %-16s |%n";
        System.out.format("+-----------+------------+------------+----------+--------+------------+--------------+--------+------------+------------------+%n");
    ...
    public static void main(String[] args) {
        ...
        //display
        String format = "| %-9s | %-10s | %-10s | %-8s | %-6s | %-10s | %-12s | %-6s | %-10s | %-16s |%n";
        System.out.format("+-----------+------------+------------+----------+--------+------------+--------------+--------+------------+------------------+%n");
        ...
        if(count1==0)
            ...
            System.out.println("Records found: "+count1);
        ...
        if(count2==0)
            ...
            System.out.println("Records found: "+count2);
        ...
        if(count3==0)
            ...
            System.out.println("Records found: "+count3);
    }
}
